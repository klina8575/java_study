...
//		arr3.length = 10; length는 값을 읽을수만 있다.
		...
		/*
		 * // String[] season = {"Spring", "Summer", "Fall", "Winter"}; // String
		 * season2[]; 선언만 String season[] = { "Spring", "Summer", "Fall", "Winter" };
		 * 
		 * System.out.println(season[0]); System.out.println(season[1]);
		 * System.out.println(season[2]); System.out.println(season[3]);
		 * 
		 * season[1] = "여름"; System.out.println(season[1]); System.out.println();
		 * 
		 * int[] scores = { 83, 90, 87 };
		 * 
		 * // 총합, 평균
